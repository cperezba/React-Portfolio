...
const Contact = () => {
    ...
    const userID = 'user_gYnOkkvnYKCdSTk3ihGsH';
    ...
    const sendEmail = (serviceID, templateID, variables, userID) => {
        emailjs.send(serviceID, templateID, variables, userID)
            .then(() => {
                setSuccessMessage("Form sent succesfully! I'll be contacting you as soon as possible.");
                        ...
                        <div className="col-md-6 col-sx-12">
                            ...
                            <div className="text-center">
                                <textarea
                                    ...
                                    ref={
                                        register({
                                            required: "Please provide the content of your message",
                                        })
                                    }
                                ></textarea>
                                <div className="line"></div>
